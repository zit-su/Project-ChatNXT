...
public class VerifyEmailActivity extends AppCompatActivity {
	...
	public void _UI() {
		...
		if (FirebaseAuth.getInstance().getCurrentUser() != null) {
			...
			if (emailMatcher.find()) {
				...
				spannableString2.setSpan(new ClickableSpan() {
					...
					public void onClick(@NonNull View widget) {
						Toast.makeText(getApplicationContext(), "Email clicked: " + foundEmail, Toast.LENGTH_SHORT).show();
					}
					
					@Override
					public void updateDrawState(@NonNull TextPaint ds) {
						super.updateDrawState(ds);
						ds.setColor(Color.BLUE);  // Email in Blue
						ds.setUnderlineText(true); // Underline Email
					}
			...
			// ✅ Highlight "Resend confirmation mail"
			TextView textView3 = findViewById(R.id.textview3);
			String originalText = "If you not got any mail Resend confirmation mail";
			...
			if (startIndex != -1) {
				spannableString3.setSpan(new ForegroundColorSpan(Color.BLUE), startIndex, endIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
				spannableString3.setSpan(new StyleSpan(Typeface.BOLD), startIndex, endIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
				spannableString3.setSpan(new ClickableSpan() {
					...
					public void onClick(@NonNull View widget) {
						...
						Toast.makeText(getApplicationContext(), "Resending Mail...", Toast.LENGTH_SHORT).show();
						// Add Resend Mail Logic
					}
