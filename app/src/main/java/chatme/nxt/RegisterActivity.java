...
*/
				final DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("users");
				final EditText editTextUsername = findViewById(R.id.tx_username);
				...
				// Prevent usernames like ___ or _____
				else if (textValue.replace("_", "").isEmpty()) {
				...
				else if (!textValue.matches(specialCharacterPattern)) {
					
					editTextUsername.setError("Only letters, numbers and underscore allowed!");
					valid = false;
					...
					usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
						...
						public void onDataChange(@NonNull DataSnapshot snapshot) {
							...
							for (DataSnapshot userSnapshot : snapshot.getChildren()) {
								...
								if (userValue != null &&
								userValue.trim().toLowerCase().equals(textValue)) {
...
*/
	...
	public void _updated_nullDP() {
		randomS = SketchwareUtil.getRandom((int)(0), (int)(10));
		if (randomS == 0) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765609.png?raw=true").commit();
		}
		if (randomS == 1) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765613.png?raw=true").commit();
		}
		if (randomS == 2) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765617.png?raw=true").commit();
		}
		if (randomS == 3) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765622.png?raw=true").commit();
		}
		if (randomS == 4) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765628.png?raw=true").commit();
		}
		if (randomS == 5) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765631.png?raw=true").commit();
		}
		if (randomS == 6) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765637.png?raw=true").commit();
		}
		if (randomS == 7) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765643.png?raw=true").commit();
		}
		if (randomS == 8) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765648.png?raw=true").commit();
		}
		if (randomS == 9) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765653.png?raw=true").commit();
		}
		if (randomS == 10) {
			file.edit().putString("nulldp", "https://github.com/zit-su/ProfileURL/blob/main/glob/4765657.png?raw=true").commit();
		}
	}
