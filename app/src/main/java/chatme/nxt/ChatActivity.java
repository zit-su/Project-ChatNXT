	...
	public void _CreatePopup(final View _view) {
		...
		r1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				// Dismiss the popup after initiating the removal process
				popup.dismiss();
			}
		});
